...
class AdminRegisterView(CreateView):
    ...
    def form_valid(self,form):
        ...
        subject = "django"
        message = "Now you are a fosterface!! You are Admin now"
...
class ManagerRegisterView(CreateView):
    ...
    def form_valid(self,form):
        ...
        user=form.save()
        recipient_list = [email]
        subject = "This is a mail from Fostering linux."
        message = "Now you are a fosterface!! You are Manager now"
        email_from = settings.EMAIL_HOST_USER
        send_mail(subject, message, email_from, recipient_list)
        #print(email)
        login(self.request,user)
...
class DeveloperRegisterView(CreateView):
    ...
    def form_valid(self,form):
        ...
        recipient_list = [email]
        subject = "This is a mail from Fostering linux."
        message = "Now you are a fosterface!! You are Developer now"
        email_from = settings.EMAIL_HOST_USER
        send_mail(subject, message, email_from, recipient_list)
        #print(email)
        login(self.request,user)
